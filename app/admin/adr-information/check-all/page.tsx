...
export default function CheckAllADRFeatures() {
  ...
  const [tests, setTests] = useState<TestResult[]>([
    { name: '1. Kiểm tra User và Permissions', status: 'pending' },
    { name: '2. Kiểm tra Database Schema', status: 'pending' },
    { name: '3. Kiểm tra RLS Policies', status: 'pending' },
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">🔍 Kiểm tra toàn bộ ADR Information</h1>
              <p className="text-gray-600 mt-1">Comprehensive test của tất cả chức năng</p>
            </div>
          </div>
          ...
          >
            ...
            <span>{running ? 'Đang test...' : 'Chạy tất cả tests'}</span>
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg border shadow-sm">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Tổng tests</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          <div className="p-6 border-b">
            <h2 className="text-lg font-semibold">Kết quả kiểm tra</h2>
          </div>
        ...
        {errorCount > 0 && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <h2 className="text-lg font-semibold text-red-900 mb-4">🚨 Cần fix các lỗi sau:</h2>
        ...
        {successCount === totalTests && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <p className="text-green-800">
              ADR Information feature đã sẵn sàng sử dụng. Bạn có thể tạo tin tức mới ngay bây giờ.
            </p>
            <div className="mt-4">
