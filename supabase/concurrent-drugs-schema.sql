-- Migration: Create concurrent_drugs table for ADR reports
...
-- Policy: Users can only access concurrent drugs of their own reports or if they are admin
CREATE POLICY "Users can view concurrent drugs of accessible reports"
...
-- Policy: Users can insert concurrent drugs for their own reports
...
-- Policy: Users can update concurrent drugs of their own reports or if they are admin
...
-- Policy: Users can delete concurrent drugs of their own reports or if they are admin
...
-- This will be automatically linked to existing reports
